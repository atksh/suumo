...
from os.path import expanduser, expandvars, getmtime, isfile
...
def cache_function_value(
    function_value, n_days_to_cache, cache_metadata, function_name, *args, **kwargs
):
    if function_name == _TOTAL_NUMCACHE_KEY:
...
def _cache_to_disk_wrapper(
    original_func, n_days_to_cache, _CacheInfo
